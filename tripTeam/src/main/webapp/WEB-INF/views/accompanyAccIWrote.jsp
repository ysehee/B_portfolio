...
<head>
	...
	<title>Blue Horizon 블루호라이즌 마이페이지 - 내가 쓴 동행글</title>
...
<div id="wrap">
	...
	<div class="accompany_box">
		<div class="accompany_title">
			<h1 class="font_800_accom" >내가 쓴 동행글</h1>
...
<%--				<th class="comment_count">동행글 댓글 수</th>--%>
				<th class="like_count">동행글 좋아요 수</th>
				<th class="view_count">동행글 조회수</th>
<%--				<th class="reg_date">동행글 생성일자</th>--%>

			</tr>
			</thead>
			<tbody>
			<c:forEach var="accompanyListIWrote" items="${accompanyListIWrote}">
				<tr class="accompanyItem">
					<td class="title">
						<a href="<c:url value="/accompany/read?accompanyNo=${accompanyListIWrote.accompanyNo}"/>">${accompanyListIWrote.accompanyTitle}</a>
					</td>
					<td class="writer"> ${accompanyListIWrote.accompanyWriter}</td>

<%--					<td class="comment_count">${accompanyListIWrote.accompanyLikeCnt}</td>--%>
					<td class="like_count">${accompanyListIWrote.accompanyLikeCnt}</td>
					<td class="view_count">${accompanyListIWrote.accompanyViewCnt}</td>
