    ...
    <div id="wrap">
        ...
        <div class="w_find_800">
            <div class="login_find_wrap">
                ...
                <form id="findForm" action="<c:url value='/login/findIdCheck'/>" method="post" onsubmit="return findSubmitId()">
                    <div class="form-group">
                        <input type="text" name="userName" id="name" placeholder="이름" onblur="findSubmitId()">
                        <div id="name_Error" class="find_error "></div>
                    </div>
                    <div class="form-group">
                        <input type="email" name="userEmail" id="email" placeholder="이메일" onblur="findSubmitId()">
                        <div id="email_Error" class="find_error "></div>
                    </div>
                    <button type="submit" id="id-find" class="btn_css" >아이디 찾기</button>
