...
<head>
	...
	<title>Blue Horizon 블루호라이즌 마이페이지 - 내가 쓴 동행댓글</title>
...
<div id="wrap">
	...
	<div class="accompany_box">
		<div class="accompany_title">
			<h1 class="font_800_accom" >내가 쓴 동행 댓글</h1>
		...
		<table>
			...
			<tr>
				...
				<th class="comment_content">동행글 댓글내용</th>


			</tr>
			</thead>
			<tbody>
			<c:forEach var="accompanyListCmtIWrote" items="${accompanyListCmtIWrote}">
				<tr class="boaaccompanyItemrdBody">
					<td class="title">
						<a href="<c:url value="/accompany/read?accompanyNo=${accompanyListCmtIWrote.accompanyNo}"/>">${accompanyListCmtIWrote.accompanyTitle}</a>
					</td>
					<td class="writer"> ${accompanyListCmtIWrote.accompanyCommentWriter}</td>

					<td class="comment_content">${accompanyListCmtIWrote.accompanyCommentContent}</td>
