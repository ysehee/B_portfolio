    ...
    <div class="select_form">
        ...
        <div class="section_left tab-content current" id="tab-1" >
            ...
            <div class="form_title">
                <h1 class="font_800" >내 동행</h1>
            </div>
            <ul class="accompany_ul">
                <li class="accompany_li"><a href="<c:url value='/accompany/accIWrote' />">내가 쓴 동행글</a></li>
                <li class="accompany_li"><a href="<c:url value='/accompany/accCmtIWrote' />">내가 쓴 동행댓글</a></li>
                <li class="accompany_li"><a href="<c:url value='/accompany/spendAccApy' />">내가 보낸 동행신청</a></li>
                <li class="accompany_li"><a href="<c:url value='/accompany/receiveAccApy' />">내가 받은 동행신청</a></li>
                <li class="accompany_li"><a href="<c:url value='/accompany/accConnectionList' />">동행 확정내역</a></li>
            </ul>
