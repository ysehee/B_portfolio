...
<body>
    ...
    <div id="wrap">
        ...
        <div class="w_find_result_800">
            <div class="login_find_result_wrap">


                <div class="login_find_result_title">
                    <p>회원님의 아이디를 확인해 주세요</p>
                </div>
                ...
                <div class="login_input">
                    <div class="result-box">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <p class="inquiry">${findId.userId}</p>
                            </c:otherwise>
                        </c:choose>
                    </div>
<%--                        <input type="submit" value="아이디 찾기" name="login_btn" onclick="showAlert('${URLDecoder.decode(msg)}')">--%>

                        <div class="login_find_result_txt">
                            <div class="login_join result_btn">
                                <a href="<c:url value='/login/login' />"><span>로그인하기</span></a>
                            </div>
                            <a class="result_btn"  href="<c:url value='/login/findPw' />"><p>비밀번호 찾기</p></a>
                        </div>
                </div>
            </div>
